...
REQUIREMENTS = [
    ...
    'https://github.com/felixstorm/bellows/archive/master.zip#bellows==0.6.0.devfstorm1',
    'https://github.com/felixstorm/zigpy-xbee/archive/master.zip#zigpy-xbee==0.1.1.devfstorm0',
]
